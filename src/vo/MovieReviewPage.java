...
public class MovieReviewPage {
	...
	public MovieReviewPage(List<MovieReview> movieList, int nowPage, int totalPage, int startArticleNo, int endArticleNo ){
	...
	public MovieReviewPage(List<MovieReview> movieList, int nowPage, int perPage, int totalPage, int startArticleNo, int endArticleNo, int perList, int startListNo, int endListNo) {
		this.movieList = movieList;
		this.nowPage = nowPage;
	...
	public List<MovieReview> getMovieList() {
		return movieList;
	}
