...
<body>
	...
	<header>
		...
		<a href="movie?type=myPage"><button id="inform">회원정보</button></a> <a
			href="movie?type=logout"><button id="inform">로그아웃</button></a>
						...
						<div class="container">
							...
							<div class="nav-collapse nav-collapse_  collapse">
								<ul class="nav sf-menu">
									...
									<li class="sub-menu"><a href="Mmovie?type=soonMovie">개봉예정
									</a> <!--                       <ul> --> <!--                     <li><a href="#">Dolore </a></li> -->
