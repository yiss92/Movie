...
<!--                 <div> -->
<!--                     <label class="name"> -->
<%--                     <input type="text" name="title" value="${requestScope.ori.articleTitle}"> --%>
<!--                     <br> -->
<!--                     </div> -->
              
<!--               <form action="board" method="post"> -->
<%-- 		제목 : <input type="text" name="title" size="20" value="${requestScope.ori.articleTitle}"><br> --%>
<!-- 		글내용 : <br> -->
...
<!--                     <textarea name="content"></textarea> -->
					...
					<br>
					<h3>회원가입에 실패했습니다.</h3>
					<a href="board?type=list">[다시 회원가입]</a>
					<h3>회원가입에 성공했습니다.</h3>
					<a href="board?type=list">[로그인]</a>
                    <br>
