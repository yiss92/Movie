						...
						<div class="inner-1">
							<ul class="list-blog">
								<li>
									...
									<h5>감독 : ${requestScope.now.director}</h5>
									<h5>주연배우 : ${requestScope.now.star}</h5>
									<h5>장르 : ${requestScope.now.genre1} ${requestScope.now.genre2}</h5>
									<h5>${requestScope.now.story}</h5> 
									
									<table border="1">
										<tr>
											<th width="250" height="30">평점</th>
											<th width="250" height="30">한줄 평</th>
											<th width="250" height="30">ID</th>
										</tr>
										<c:choose>
