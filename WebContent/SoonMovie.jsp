...
<header>
    ...
    <div class="row">
        ...
        <div class="navbar navbar_">
              <div class="container">
            <h1 class="brand brand_"><a href="index.html"><img alt="" src="img/MainTopic.JPG"> </a></h1>
            <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse_">Menu <span class="icon-bar"></span> </a>
            <div class="nav-collapse nav-collapse_  collapse">
                  <ul class="nav sf-menu">
                <li><a href="index.html">상영작</a></li>
                <li class="sub-menu active"><a href="index-1.html">개봉예정</a>
<!--                       <ul> -->
    ...
    <div class="container">
        ...
        <ul class="thumbnails thumbnails-1 list-services">
            ...
            <div class="thumbnail thumbnail-1"> <img  src="/Movie${soon.movieImage}" alt="">
                  <section> <a href="#" class="link-1">${soon.movieTitle}</a>
